...
import com.example.distributedsystems.leader.LeaderElection;
...
public class Application implements Watcher {
    ...
    public static void main(String[] args) throws IOException, InterruptedException, KeeperException {
        ...
        OnElectionAction onElectionAction = new OnElectionAction(workersServiceRegistry, coordinatorServiceRegistry, currentServerPort);
